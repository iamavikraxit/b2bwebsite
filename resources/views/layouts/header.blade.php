<div class="page-header row">
    <div class="header-logo-wrapper col-auto">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                    ...
                    src="{{ asset('backend/images/logo/logo_light.png') }}" alt="" /></a></div>
    </div>
    ...
    <div class="header-wrapper col m-0">
                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="notification-box">
                            <svg>
                                <use href="{{asset('backend/svg/icon-sprite.svg#notification')}}"></use>
                            ...
                            <ul class="notification-box">
                                <li class="d-flex">
                                    <div class="flex-shrink-0 bg-light-primary"><img
                                            src="{{ asset('backend/images/dashboard/icon/wallet.png') }}"
                                            alt="Wallet">
                                    </div>
                    ...
                    <li class="onhover-dropdown">
                        <svg>
                            <use href="{{asset('backend/svg/icon-sprite.svg#header-bookmark')}}"></use>
                        </svg>
                    ...
                    <li>
                        <div class="mode">
                            <svg>
                                <use href="{{asset('backend/svg/icon-sprite.svg#moon')}}"></use>
                            </svg>
                        </div>
                    </li>
                    <li class="onhover-dropdown">
                        <div class="notification-box">
                            <svg>
                                <use href="{{asset('backend/svg/icon-sprite.svg#header-message')}}"></use>
                            ...
                            <ul class="messages">
                                <li class="d-flex b-light1-primary gap-2">
                                    <div class="flex-shrink-0"><img
                                            src="{{ asset('backend/images/dashboard-2/user/1.png') }}" alt="Graph">
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex b-light1-secondary gap-2">
                                    <div class="flex-shrink-0"><img
                                            src="{{ asset('backend/images/dashboard-2/user/2.png') }}" alt="Graph">
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                                ...
                                <li class="d-flex b-light1-success gap-2">
                                    <div class="flex-shrink-0"><img
                                            src="{{ asset('backend/images/dashboard-2/user/3.png') }}" alt="Graph">
                                    </div>
                                    <div class="flex-grow-1"> <a href="private-chat.html">
                    ...
                    <li class="cart-nav onhover-dropdown">
                        <div class="cart-box">
                            <svg>
                                <use href="{{asset('backend/svg/icon-sprite.svg#stroke-ecommerce')}}"></use>
                            </svg>
                        </div>
                            ...
                            <ul>
                                <li>
                                    <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                            src="{{ asset('backend/images/other-images/cart-img.jpg') }}"
                                            alt="">
                                ...
                                <li>
                                    <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                            src="{{ asset('backend/images/other-images/table-img.jpg') }}"
                                            alt="">
                    ...
                    <li class="profile-nav onhover-dropdown px-0 py-0">
                        ...
                        <ul class="profile-dropdown onhover-show-div">
                            <li>
                                <a href="private-chat.html"><i data-feather="user"></i><span>Account</span></a>
                            </li>
      ...
      <div class="ProfileCard-realName">Avik</div>
      </div>
      </div>
    </script>
